...
public class HTTPServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        sparkController.get("/test", (req, res) -> {
            return "Peticion GET!";
        });

        sparkController.post("/testPost", (req, res) -> {
        ...
        while(running){
            ...
            try{
                if(sparkController.hasEndPoint(path)){
                    readFile.lecturaController(clientSocket, sparkController, path, metodo);
